package com.missouristate.arnold.deviceorientation;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkDimensions(Configuration config) {
        ...
        b1.measure(ActionBar.LayoutParams.WRAP_CONTENT, ActionBar.LayoutParams.WRAP_CONTENT);
    ...
    public void setUpGui() {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, ActionBar.LayoutParams.WRAP_CONTENT);
